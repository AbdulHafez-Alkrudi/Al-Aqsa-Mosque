...
Pillar::Pillar(float base_side_length , float cylinder_length): base_side_length(base_side_length) , cylinder_length(cylinder_length){}


void Pillar::cube_cylinder_pillar(Point str , int base_texture , int cylinder_texture , bool with_lower_base , bool with_upper_base ){
